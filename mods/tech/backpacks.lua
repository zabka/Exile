...
-- fabric
backpacks.register_backpack("fabric_bag", S("Fabric Bag"), "tech_coarse_fabric.png", 8,4, {snappy = 3, dig_immediate = 3, temp_pass = 1, craftedby = 1}, nodes_nature.node_sound_leaves_defaults())
