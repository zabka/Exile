...
local function can_smolder(pos, meta, fire_name, ash_name)
	...
	if climate.get_rain(pos) or minetest.find_node_near(pos, 1, {"group:puts_out_fire"}) then
	        f = f - wet_loss
		if f <= 0 then
		   minetest.swap_node(pos, {name = ash_name})
		else
...
minetest.register_node("tech:charcoal_block", {
	...
	on_burn = function(pos)
		minetest.swap_node(pos, {name = "tech:large_charcoal_fire"})
...
minetest.register_node("tech:charcoal", {
	...
	sounds = nodes_nature.node_sound_dirt_defaults(),
	on_burn = function(pos)
		minetest.swap_node(pos, {name = "tech:small_charcoal_fire"})
		minetest.check_for_falling(pos)
	end,
...
minetest.register_node('tech:small_wood_fire_unlit', {
	...
	on_burn = function(pos)
		minetest.swap_node(pos, {name = "tech:small_wood_fire"})
		minetest.check_for_falling(pos)
	end
})
...
minetest.register_node('tech:large_wood_fire_unlit', {
	...
	sounds = nodes_nature.node_sound_wood_defaults(),
	on_burn = function(pos)
		minetest.swap_node(pos, {name = "tech:large_wood_fire"})
		minetest.check_for_falling(pos)
	end
})
...
minetest.register_node('tech:small_wood_fire', {
	...
	on_timer =function(pos, elapsed)
		...
		if fuel < 1 then
			minetest.swap_node(pos, {name = "tech:wood_ash"})
			return false
...
minetest.register_node('tech:large_wood_fire', {
	...
	on_timer =function(pos, elapsed)
		...
		local fuel = meta:get_int("fuel")
		if fuel < 1 then
			minetest.swap.node(pos, {name = "tech:wood_ash_block"})
			return false
...
minetest.register_node('tech:small_wood_fire_smoldering', {
	...
	on_timer =function(pos, elapsed)
		...
		local fuel = meta:get_int("fuel")
		if fuel < 1 then
			minetest.swap_node(pos, {name = "tech:charcoal"})
			return false
		else
...
minetest.register_node('tech:large_wood_fire_smoldering', {
	...
	on_timer =function(pos, elapsed)
		...
		local fuel = meta:get_int("fuel")
		if fuel < 1 then
			minetest.swap_node(pos, {name = "tech:charcoal_block"})
			return false
		else
...
minetest.register_node('tech:large_charcoal_fire', {
	...
	on_timer =function(pos, elapsed)
		...
		local fuel = meta:get_int("fuel")
		if fuel < 1 then
			minetest.swap_node(pos, {name = "tech:wood_ash_block"})
			return false
